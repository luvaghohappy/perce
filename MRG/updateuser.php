...
$email = htmlspecialchars($_POST["Email"]);
    ...
    $sql = "UPDATE users SET nom = '$nom', postnom ='$postnom', prenom='$prenom',sexe='$sexe',org_privee='$org',Formation='$formation',paiement='$paiement',Date_debut='$datedebut',Date_fin='$datefin',Lieu='$lieu',Telephone='$telephone',Email='$email'  WHERE id = '$id'";

...
class _InsertAdminState extends State<InsertAdmin> {
  ...
  Future<void> updateData(String id) async {
    ...
    final response = await http.post(
      Uri.parse("http://192.168.43.148:81/MRG/updateadmin.php"),
      body: {
        'id': id,
        'email': email,
        'passwords': password,
  ...
  Future<void> deleteData(BuildContext context, String id) async {
    ...
    if (confirmDelete == true) {
      var url = 'http://192.168.43.148:81/MRG/deleteadmin.php?id=$id';
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
        Uri.parse("http://192.168.43.148:81/MRG/select.php"),
      );
      setState(() {
  ...
  Future<void> insertData() async {
    final response = await http.post(
      Uri.parse("http://192.168.43.148:81/MRG/insertadmin.php"),
      body: {
        'email': txtemail.text,
